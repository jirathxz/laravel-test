...
### 🔧 ระบบแจ้งซ่อมอุปกรณ์คอมพิวเตอร์ (Computer Repair Service)
- **ส่งคำขอแจ้งซ่อมออนไลน์ (Submit Ticket)**: กรอกข้อมูลอุปกรณ์ (PC, Notebook, MacBook, อะไหล่), อาการเสีย, และรูปแบบการส่งซ่อม (ส่งที่ร้าน หรือ นัดรับที่บ้าน)
- **ระบบติดตามสถานะงานซ่อมแบบเรียลไทม์ (Track Repair Progress)**: ค้นหาความคืบหน้าด้วยรหัสใบแจ้งซ่อม (เช่น `REP-20260920-0001`)
- **ไทม์ไลน์ 5 ขั้นตอนมาตรฐาน**: ได้รับเรื่องแล้ว ➔ ตรวจสอบอาการ ➔ กำลังซ่อม ➔ รออะไหล่ ➔ ซ่อมเสร็จสิ้น
- **บันทึกจากช่างและราคาประเมิน**: แสดงรายละเอียดการตรวจเช็คทางเทคนิคและค่าบริการอย่างโปร่งใส
- **โหมดจำลองสำหรับทดสอบ (Demo Advance Status)**: มีปุ่มจำลองการเปลี่ยนสถานะงานซ่อมแบบเรียลไทม์เพื่อใช้ในการนำเสนอและตรวจประเมิน
